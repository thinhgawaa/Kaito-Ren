# NỘI QUY NHÓM IT BF End Community

Để tránh việc bị Kick, Ban, ăn Gug hoặc bị xóa bài mà không biết nguyên nhân tại sao, đề nghị các bạn vui lòng **đọc kỹ nội quy** trước khi tham gia nhóm.

## NỘI QUY VỀ TÀI KHOẢN

Những tài khoản có dạng như sau sẽ **KHÔNG** được phép tham gia nhóm:
- Vừa tham gia Facebook được 1 tuần.
...
- Khi đăng nội dung liên quan đến vấn đề 18+ hay mã hóa nhé như dùng trang [base64encode](https://www.base64encode.org/)

### VỀ CHỦ ĐỀ

- Nên ưu tiên chủ đề về công nghệ, lập trình và bảo mật. Chấp nhận các bài giải trí (miễn là không quá nhảm). Các bài viết có dạng như sau sẽ KHÔNG được duyệt **Các mod và Admin chú ý khi xét duyệt nhé**:
...
- Các bài hướng dẫn, chia sẻ tool DDOS/Botnet/Malware/Virus cấm nhé.
- **KHÔNG** đăng bài viết liên quan đến chủ đề chính trị, tôn giáo.
- Bài viết mang tính chất lôi kéo thành viên qua nhóm khác.
- Bài chỉ có mỗi liên kết mà không có mô tả gì (spam câu view, like).

### VỀ HASHTAG ( Không ép buộc )

Các bài viết chia sẻ tài liệu, ebook, mã nguồn hoặc bất cứ thứ gì mà thành viên khác có thể tải về được thì bạn vui lòng sử dụng hashtag  chứa từ khóa liên quan tới tài liệu (ví dụ: [#security](https://www.facebook.com/hashtag/security) nếu nội dung về bảo mật, [#php](https://www.facebook.com/hashtag/php) nếu chia sẻ ebook học PHP) để giúp BQT dễ dàng tổng hợp và phân loại tài nguyên.Đồng thời cũng giúp các thành viên khác có thể dễ dàng tìm bài viết hoặc chính bạn tìm lại sau này.

**Điều đặt Hashtag là không ép buốc nhé**
...
- **Tránh** sử dụng "chấm" (".") hoặc "hóng", hãy dùng chức năng "Bật thông báo cho bài viết" hoặc "Lưu bài viết" nếu bạn muốn theo dõi cập nhật của bài viết.
 ...
 **KHi vi phạm cả mem lẫn ban quan trị đều có mức độ sử phạm không thiên vị bất cứ ai**
---
...
Ban quản trị sẽ luôn sẵn sàng nghe nhưng ý kiến và câu hỏi về luật, BQT có quyền không trả lời những câu hỏi không cần thiết. 
Nhóm có một Group Chat để các mem và admin có thể dễ dàng nhận được câu trả lời nhanh chóng [#security](https://www.facebook.com/groups/IT.BF.End.Community/permalink/249288468864750/)

P/S: Nội quy sẽ được sửa đổi, cập nhật theo thời gian sao cho phù hợp.
P/S: Nội quy được tham khảo từ J2Team và đã được sửa lại cho hợp 
